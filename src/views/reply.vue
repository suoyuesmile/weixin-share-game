...
<script>
import Vue from 'vue'
import { NavBar, Collapse, CollapseItem, Divider, Popup, Field, CellGroup, Toast } from 'vant'
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      ...
      const res = await getCommentsDetail({ replierId: id, curOpenid: this.curOpenid })
